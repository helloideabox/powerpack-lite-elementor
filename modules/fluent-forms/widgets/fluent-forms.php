	...
	protected function render() {
		...
		if ( function_exists( 'wpFluentForm' ) ) {
			if ( ! empty( $settings['contact_form_list'] ) ) {
				...
				$title_id  = 'pp-fluent-form-title-' . $widget_id;
				$desc_id   = 'pp-fluent-form-desc-' . $widget_id;
				...
				$this->add_render_attribute( 'contact-form', [
					'role'       => 'region',
					'aria-label' => $has_title ? esc_attr( $settings['form_title_custom'] ) : esc_attr( $this->get_title() ),
				] );
				?>
				<div <?php $this->print_render_attribute_string( 'contact-form' ); ?>>
					<?php if ( $has_title || $has_desc ) { ?>
						<div class="pp-fluent-forms-heading">
							<?php if ( $has_title ) { ?>
								<<?php PP_Helper::print_validated_html_tag( $title_tag ); ?> id="<?php echo esc_attr( $title_id ); ?>" class="pp-contact-form-title pp-fluent-forms-title">
									<?php echo esc_html( $settings['form_title_custom'] ); ?>
								</<?php PP_Helper::print_validated_html_tag( $title_tag ); ?>>
							<?php } ?>
							<?php if ( $has_desc ) { ?>
								<div id="<?php echo esc_attr( $desc_id ); ?>" class="pp-contact-form-description pp-fluent-forms-description">

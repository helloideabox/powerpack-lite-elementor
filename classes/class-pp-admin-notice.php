...
class PP_Modules_Reviews {
	...
	public static function triggers( $group = null, $code = null ) {
		...
		if ( ! isset( $triggers ) ) {
			...
			$sale_message = __( "Upgrade to PowerPack Pro with 60+ Widgets for a <strong>HUGE 40% Discount</strong> during our Biggest Sale of the Year. Get it now!", 'powerpack' );
		...
		<div class="notice is-dismissible pp-notice">
			...
			<div class="pp-admin-review-logo-wrapper">
				<a href="https://powerpackelements.com/" title="Visit PowerPack for Elementor's Website" target="_blank">
					<img class="logo" src="<?php echo POWERPACK_ELEMENTS_LITE_URL . 'assets/images/icon-256x256.png'; ?>" />
				</a>
			</div>

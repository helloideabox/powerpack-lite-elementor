...
class PP_Config {
	...
	public static function widgets_help_links() {
		...
		self::$help_docs = array(
			// Business Hours.
			'Advanced_Accordion'    => array(
				esc_html__( 'Widget Overview', 'powerpack-lite-for-elementor' ) => 'https://powerpackelements.com/docs/advanced-accordion-widget-overview/' . $utm_suffix,
			),
			// Business Hours.
			'Business_Hours'    => array(
				esc_html__( 'Widget Overview', 'powerpack-lite-for-elementor' ) => 'https://powerpackelements.com/docs/powerpack/widgets/business-hours/business-hours-widget-overview/' . $utm_suffix,
			),
			// Counter.
			'Counter'           => array(
				esc_html__( 'Watch Video Overview', 'powerpack-lite-for-elementor' ) => 'https://www.youtube.com/watch?v=g70UKxK_1dU&list=PLpsSO_wNe8Dz4vfe2tWlySBCCFEgh1qZj',
				esc_html__( 'Widget Overview', 'powerpack-lite-for-elementor' )      => 'https://powerpackelements.com/docs/powerpack/widgets/counter/counter-widget-overview/' . $utm_suffix,
			),
			// Content Ticker.
			'Content_Ticker'     => array(
				esc_html__( 'Widget Overview', 'powerpack-lite-for-elementor' )      => 'https://powerpackelements.com/docs/content-ticker-widget-overview/' . $utm_suffix,
			),
			// Counter.
			'Counter'            => array(
				esc_html__( 'Watch Video Overview', 'powerpack-lite-for-elementor' ) => 'https://www.youtube.com/watch?v=g70UKxK_1dU&list=PLpsSO_wNe8Dz4vfe2tWlySBCCFEgh1qZj',
			...
			// Divider.
			'Divider'       => array(
				esc_html__( 'Widget Overview', 'powerpack-lite-for-elementor' ) => 'https://powerpackelements.com/docs/divider-widget-overview/' . $utm_suffix,
			),
			// Dual Heading.
			'Dual_Heading'      => array(
				esc_html__( 'Widget Overview', 'powerpack-lite-for-elementor' ) => 'https://powerpackelements.com/docs/powerpack/widgets/dual-heading/dual-heading-widget-overview/' . $utm_suffix,
			),
			// Fancy Heading.
			'Fancy_Heading'     => array(
				esc_html__( 'Widget Overview', 'powerpack-lite-for-elementor' ) => 'https://powerpackelements.com/docs/fancy-heading-widget-overview/' . $utm_suffix,
				esc_html__( 'Watch Video Overview', 'powerpack-lite-for-elementor' ) => 'https://www.youtube.com/watch?v=PxWWUTeW4dc&list=PLpsSO_wNe8Dz4vfe2tWlySBCCFEgh1qZj',
			),
			// Flip Box.
			'Flipbox'           => array(
				esc_html__( 'Widget Overview', 'powerpack-lite-for-elementor' ) => 'https://powerpackelements.com/docs/powerpack/widgets/flip-box/flip-box-widget-overview/' . $utm_suffix,
			),
			// Fluent Forms.
			'Fluent_Forms'       => array(
				esc_html__( 'Watch Video Overview', 'powerpack-lite-for-elementor' ) => 'https://www.youtube.com/watch?v=fvPnKNpsNyc&list=PLpsSO_wNe8Dz4vfe2tWlySBCCFEgh1qZj',
			),
			// Gravity Forms.
			'Gravity_Forms'     => array(
				esc_html__( 'Watch Video Overview', 'powerpack-lite-for-elementor' ) => 'https://www.youtube.com/watch?v=fw47JcVDIpI&list=PLpsSO_wNe8Dz4vfe2tWlySBCCFEgh1qZj',
			),
			// Image Hotspots.
			'Hotspots'          => array(
				esc_html__( 'Widget Overview', 'powerpack-lite-for-elementor' ) => 'https://powerpackelements.com/docs/powerpack/widgets/image-hotspots/image-hotspots-widget-overview/' . $utm_suffix,
			),
			// Icon List.
			'Icon_List'          => array(
				esc_html__( 'Widget Overview', 'powerpack-lite-for-elementor' ) => 'https://powerpackelements.com/docs/powerpack/widgets/icon-list/icon-list-widget-overview/' . $utm_suffix,
			),
			// Image Accordion.
			'Image_Accordion'   => array(
				esc_html__( 'Widget Overview', 'powerpack-lite-for-elementor' ) => 'https://powerpackelements.com/docs/image-accordion-widget-overview/' . $utm_suffix,
			),
			// Image Comparison.
			'Image_Comparison'   => array(
				esc_html__( 'Widget Overview', 'powerpack-lite-for-elementor' ) => 'https://powerpackelements.com/docs/powerpack/widgets/image-comparison/image-comparison-widget-overview/' . $utm_suffix,
			),
			// Info Box.
			'Info_Box'          => array(
				esc_html__( 'Widget Overview', 'powerpack-lite-for-elementor' ) => 'https://powerpackelements.com/docs/powerpack/widgets/info-box/info-box-widget-overview/' . $utm_suffix,
			),
			// Info Box Carousel.
			'Info_Box_Carousel' => array(
				esc_html__( 'Widget Overview', 'powerpack-lite-for-elementor' ) => 'https://powerpackelements.com/docs/powerpack/widgets/info-box-carousel/info-box-carousel-widget-overview/' . $utm_suffix,
			),
			// Info List.
			'Info_List'         => array(
				esc_html__( 'Widget Overview', 'powerpack-lite-for-elementor' ) => 'https://powerpackelements.com/docs/powerpack/widgets/info-list/info-list-widget-overview/' . $utm_suffix,
			),
			// Info Table.
			'Info_Table'        => array(
				esc_html__( 'Widget Overview', 'powerpack-lite-for-elementor' ) => 'https://powerpackelements.com/docs/info-table-widget-overview/' . $utm_suffix,
			),
			// Instafeed.
			'Instafeed'         => array(
				esc_html__( 'Watch Video Overview', 'powerpack-lite-for-elementor' ) => 'https://www.youtube.com/watch?v=33A9XL1twFE&list=PLpsSO_wNe8Dz4vfe2tWlySBCCFEgh1qZj',
				esc_html__( 'Widget Overview', 'powerpack-lite-for-elementor' )      => 'https://powerpackelements.com/docs/powerpack/widgets/instagram-feed/instagram-feed-widget-overview/' . $utm_suffix,
				esc_html__( 'How to get Instagram Access Token?', 'powerpack-lite-for-elementor' ) => 'https://powerpackelements.com/docs/create-instagram-access-token-for-instagram-feed-widget/' . $utm_suffix,
				esc_html__( 'How to set up Instagram Feed widget?', 'powerpack-lite-for-elementor' ) => 'https://powerpackelements.com/docs/powerpack/widgets/instagram-feed/elementor-instagram-widget-setup/' . $utm_suffix,
			),
			// Link Effects.
			'Link_Effects'          => array(
				esc_html__( 'Widget Overview', 'powerpack-lite-for-elementor' ) => 'https://powerpackelements.com/docs/link-effects-widget-overview/' . $utm_suffix,
			),
			// Logo Carousel.
			'Logo_Carousel'     => array(
				esc_html__( 'Widget Overview', 'powerpack-lite-for-elementor' ) => 'https://powerpackelements.com/docs/powerpack/widgets/logo-carousel/logo-carousel-widget-overview/' . $utm_suffix,
			),
			// Logo Grid.
			'Logo_Grid'         => array(
			...
			// One Page Navigation.
			'Onepage_Nav'       => array(
				esc_html__( 'Watch Video Overview', 'powerpack-lite-for-elementor' ) => 'https://www.youtube.com/watch?v=onZ0mnkRJiY&list=PLpsSO_wNe8Dz4vfe2tWlySBCCFEgh1qZj',
			),
			// Posts.
			'Posts'              => array(
				esc_html__( 'Watch Video Overview', 'powerpack-lite-for-elementor' ) => 'https://www.youtube.com/watch?v=9-SF5w93Yr8&list=PLpsSO_wNe8Dz4vfe2tWlySBCCFEgh1qZj&index=14',
				esc_html__( 'Action Hooks for Post Widget', 'powerpack-lite-for-elementor' ) => 'https://powerpackelements.com/docs/powerpack/widgets/posts/actions-hooks-for-post-widget/' . $utm_suffix,
				esc_html__( 'How to Customize Query in Post Widget?', 'powerpack-lite-for-elementor' ) => 'https://powerpackelements.com/docs/powerpack/widgets/posts/how-to-customize-query-in-post-widget/' . $utm_suffix,
			),
			// Price Menu.
			'Price_Menu'        => array(
				esc_html__( 'Widget Overview', 'powerpack-lite-for-elementor' ) => 'https://powerpackelements.com/docs/powerpack/widgets/price-menu/price-menu-widget-overview/' . $utm_suffix,
			),
			// Pricing Table.
			'Pricing_Table'     => array(
				esc_html__( 'Watch Video Overview', 'powerpack-lite-for-elementor' ) => 'https://www.youtube.com/watch?v=cO-WFCHtwiM&list=PLpsSO_wNe8Dz4vfe2tWlySBCCFEgh1qZj',
				esc_html__( 'Widget Overview', 'powerpack-lite-for-elementor' )      => 'https://powerpackelements.com/docs/powerpack/widgets/pricing-table/pricing-table-widget-overview/' . $utm_suffix,
			),
			// Promo Box.
			'Promo_Box'         => array(
				esc_html__( 'Widget Overview', 'powerpack-lite-for-elementor' ) => 'https://powerpackelements.com/docs/powerpack/widgets/promo-box/promo-box-widget-overview/' . $utm_suffix,
			),
			// Random Image.
			'Random_Image'          => array(
				esc_html__( 'Widget Overview', 'powerpack-lite-for-elementor' ) => 'https://powerpackelements.com/docs/use-the-random-image-widget/' . $utm_suffix,
			),
			// Scroll Image.
			'Scroll_Image'      => array(
				esc_html__( 'Watch Video Overview', 'powerpack-lite-for-elementor' ) => 'https://www.youtube.com/watch?v=eduATa8FPpU&list=PLpsSO_wNe8Dz4vfe2tWlySBCCFEgh1qZj',
			),
			// Team Member.
			'Team_Member'        => array(
				esc_html__( 'Widget Overview', 'powerpack-lite-for-elementor' ) => 'https://powerpackelements.com/docs/team-member-widget-overview/' . $utm_suffix,
			),
			// Team Member.
			'Team_Member_Carousel' => array(
				esc_html__( 'Widget Overview', 'powerpack-lite-for-elementor' ) => 'https://powerpackelements.com/docs/team-member-carousel-widget-overview/' . $utm_suffix,
			),
			// Twitter Grid.
			'Twitter_Grid'        => array(
				esc_html__( 'Widget Overview', 'powerpack-lite-for-elementor' ) => 'https://powerpackelements.com/docs/twitter-widget-overview/' . $utm_suffix,
				esc_html__( 'How to Create a Collection URL for Twitter Grid', 'powerpack-lite-for-elementor' ) => 'https://powerpackelements.com/docs/how-to-create-a-collection-url-for-twitter-grid/' . $utm_suffix,
			),
			// Twitter Widget.
			...
			'WP_Forms'          => array(
				esc_html__( 'Widget Overview', 'powerpack-lite-for-elementor' ) => 'https://powerpackelements.com/docs/powerpack/widgets/wpforms-styler/wpforms-styler-widget-overview/',
			),
		);

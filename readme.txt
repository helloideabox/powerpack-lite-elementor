...
Self-branding is extremely important when you are working for third-party clients. This feature allows you to change the branding of the plugin and helps you maintain your personal brand while building client sites.
...
All widgets included with PowerPack come with well-thought-out design and styling options. These options make it easy for you to build creative layouts without worrying about the custom code.
...
4. [**Dual Heading**](https://powerpackelements.com/elementor-widgets/dual-heading/?utm_medium=powerpack-lite&utm_source=repo-readme&utm_campaign=repo-demo-link) - A creative widget that lets you highlight other words in a heading with different colors and variations.
...
6. [**Icon List**](https://powerpackelements.com/elementor-widgets/icon-list/?utm_medium=powerpack-lite&utm_source=repo-readme&utm_campaign=repo-demo-link) – A content widget that allows you to display a list of features with font icons or numbers for bullet points.
...
23. [**Ninja Forms Styler**](https://powerpackelements.com/elementor-widgets/contact-form/?utm_medium=powerpack-lite&utm_source=repo-readme&utm_campaign=repo-demo-link)  – Style Ninja Forms through Elementor with numerous customization options.
24. [**WPForms Styler**](https://powerpackelements.com/elementor-widgets/contact-form/?utm_medium=powerpack-lite&utm_source=repo-readme&utm_campaign=repo-demo-link) – Style WPForms through Elementor with numerous customization options.
25. [**Fluent Forms**](https://powerpackelements.com/elementor-widgets/wp-fluent-forms/?utm_medium=powerpack-lite&utm_source=repo-readme&utm_campaign=repo-demo-link) - Style WP Fluent forms through Elementor with numerous customization options.
26. [**Formidable Forms**](https://powerpackelements.com/elementor-widgets/formidable-forms/?utm_medium=powerpack-lite&utm_source=repo-readme&utm_campaign=repo-demo-link) - Style Formidable Forms through Elementor with numerous customization options.
27. [**Advanced Accordion**](https://powerpackelements.com/elementor-widgets/advanced-accordion/?utm_medium=powerpack-lite&utm_source=repo-readme&utm_campaign=repo-demo-link) – Gives the flexibility to toggle between displaying and hiding a large amount of content.
28. [**Image Accordion**](https://powerpackelements.com/elementor-widgets/image-accordion/?utm_medium=powerpack-lite&utm_source=repo-readme&utm_campaign=repo-demo-link)  – Gives the flexibility to toggle between image panels.
29. [**Flip Box**](https://powerpackelements.com/elementor-widgets/flip-box/?utm_medium=powerpack-lite&utm_source=repo-readme&utm_campaign=repo-demo-link)  – Add dual side content on information boxes with flip animations.
30. [**Content Ticker**](https://powerpackelements.com/elementor-widgets/content-ticker/?utm_medium=powerpack-lite&utm_source=repo-readme&utm_campaign=repo-demo-link)  – Display updates, popular content or messages.
31. [**Buttons**](https://powerpackelements.com/elementor-widgets/button-widget/?utm_medium=powerpack-lite&utm_source=repo-readme&utm_campaign=repo-demo-link)  – Create call-to-action button or multiple buttons with this widget.
32. [**Scroll Image**](https://powerpackelements.com/elementor-widgets/scroll-image/?utm_medium=powerpack-lite&utm_source=repo-readme&utm_campaign=repo-demo-link)  – Vertical and Horizontal scroll effect on image.
33. [**Twitter**](https://powerpackelements.com/elementor-widgets/twitter-widget/?utm_medium=powerpack-lite&utm_source=repo-readme&utm_campaign=repo-demo-link) – Embed Twitter tweet and follow buttons, embedded grid and timeline. 
34. [**Fancy Heading**](https://powerpackelements.com/elementor-widgets/fancy-heading/?utm_source=repo-readme&utm_medium=powerpack-lite&utm_campaign=repo-demo-link) - Setup stylish headings on your Elementor website with a gradient fill and background clipping options.
35. [**Posts**](https://powerpackelements.com/elementor-widgets/posts/?utm_source=repo-readme&utm_medium=powerpack-lite&utm_campaign=repo-demo-link) - Display blog posts beautifully in Post Grid, Post Carousel or Masonry Layout on your WordPress websites built through Elementor.
36. [**Content Reveal**](https://powerpackelements.com/elementor-widgets/content-reveal/?utm_source=repo-readme&utm_medium=powerpack-lite&utm_campaign=repo-demo-link) - Organize the layout of your page by displaying more content in less area. Content Reveal widget allows you to display the extra information with a simple click of a button.
...
*PowerPack offers creative widgets that are huge time savers. I have used it on several personal and client projects. While the product is reliable, their quick and friendly support makes it even better" - **Collins Agbonghama***
...
**PowerPack Pro includes all the above-mentioned Elementor widgets and the following premium addons for elementor...**
...
6. [**Off-canvas Content**](https://powerpackelements.com/elementor-widgets/offcanvas-content/?utm_medium=powerpack-lite&utm_source=repo-readme&utm_campaign=repo-demo-link)  – Allows you to create beautiful Slide-in menus. Create impressive menus, popups, or custom content displays that slide in when the trigger is activated.
...
16. [**Timeline**](https://powerpackelements.com/elementor-widgets/timeline/?utm_medium=powerpack-lite&utm_source=repo-readme&utm_campaign=repo-demo-link)  – Create stunning **Post Timeline** layouts with vertical or horizontal options for blog posts or custom post types
17. [**Magazine Slider**](https://powerpackelements.com/elementor-widgets/magazine-slider/?utm_medium=powerpack-lite&utm_source=repo-readme&utm_campaign=repo-demo-link)  – Highlight posts in a **Post Carousel** or **magazine-style Post Slider** for engaging storytelling
...
25. [**Advanced Posts**](https://powerpackelements.com/elementor-widgets/posts/?utm_source=repo-readme&utm_medium=powerpack-lite&utm_campaign=repo-demo-link) - Display blog posts beautifully on your Elementor websites with layouts such as **Post Grid** and **Post Slider** for more engaging designs
...
PowerPack template library includes 150+ ready-to-use section blocks. All block templates are the precise work of our designers that can be used to create any website.
...
### NEW SCHEMA WIDGETS For Elementor - PRO
...
With PowerPack Display Conditions, you can control how your Elementor content appears. These conditions give you complete flexibility when and where to show or hide stuff on your website. You can tweak things based on various WooCommerce factors, like the Product Category, the number of items in the Shopping Cart, the Categories the purchased items belong to, and many other cool options.
 ...
 Our Advanced Display Conditions have built-in support for Advanced Custom Fields, which allows you to display content from custom fields based on the user's browser, operating system, date, time, login status, and much more. The is the most UNIQUE solution for widgets and sections. 

https://www.youtube.com/watch?v=blCGxZujnJg

- **HEADER FOOTER BUILDER**
PowerPack addon includes a unique Header & Footer extension that allows you to create a custom Header and Footer layout. If you are using the free version of Elementor, the PowerPack Header Footer extension could be a great fit for your website.
...
The most flexible and easiest way to build an online store is with WooCommerce and Elementor. PowerPack WooCommerce builder includes a wide range of Woo Widgets that lets you design WooCommerce Single Product and Archive Page Templates. Easily!
...
Add stylish & animated backgrounds to your website.
...
Change the default mouse cursor and display icon, image, or text cursor styles on a section or a page of your website.
...
The plugin's settings screen is a React app and ships as a compiled bundle in 'assets/build/settings/'. Its uncompiled source lives in 'src/settings/', in our public development repository, together with every build tool used to produce the bundle:

[github.com/helloideabox/powerpack-lite-elementor](https://github.com/helloideabox/powerpack-lite-elementor)

To build it yourself, clone that repository and run 'npm install' followed by 'npm run build:settings', which compiles 'src/settings/index.js' with [@wordpress/scripts](https://www.npmjs.com/package/@wordpress/scripts) into 'assets/build/settings/'.

The minified stylesheets and scripts under 'assets/css/min/' and 'assets/js/min/' are generated by Grunt ('npm run build') from the unminified sources shipped alongside them, in 'assets/scss/' and 'assets/js/'.
...
You need the Elementor plugin installed and active for PowerPack to work.
...
Not at all! All the widgets and settings are easy to use with a drag & drop interface.

= How can I report security bugs? =
You can report security bugs through the Patchstack Vulnerability Disclosure Program. The Patchstack team helps validate, triage, and handle any security vulnerabilities. [Report a security vulnerability.](https://patchstack.com/database/vdp/powerpack-lite-for-elementor)
...
* 	Fix: Icon List - Icon type text was not working
...
[See changelog for all versions.](https://raw.githubusercontent.com/helloideabox/powerpack-lite-elementor/refs/heads/master/changelog.txt)